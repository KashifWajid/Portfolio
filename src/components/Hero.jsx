...
export default function Hero() {
    return (
        <section className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-purple-600 to-indigo-800 text-white px-6 pt-16">
            <motion.div
            ...
            >
                <ReactTyped
                    ...
                    backSpeed={30}
                    loop
                    className="font-mono text-indigo-100"
                />
            </motion.div>

            <motion.a
                href="#experience"
                className="bg-white text-indigo-600 px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-indigo-50 hover:shadow-xl transition-all transform hover:-translate-y-1"
