...
export default function Contact() {
    return (
        <section id="contact" className="py-20 px-6 bg-indigo-600 text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <motion.p
                    className="text-lg text-indigo-100 mb-10 leading-relaxed"
                    initial={{ opacity: 0 }}
                ...
                >
                    ...
                    >
                        <div className="bg-white/10 p-4 rounded-full mb-3 group-hover:bg-white group-hover:text-indigo-600 transition-all duration-300">
                            <FaEnvelope size={24} />
                        </div>
